...
final class NativeLibrary {
    private static final boolean DEBUG =
            System.getProperty("org.opennms.unbound4j.NativeLibrary.DEBUG") != null;
    private static final String JNI_LIBNAME = "unbound4j";
    ...
    public static void load() {
        ...
        if (jniResource == null) {
            throw new UnsatisfiedLinkError(
                    String.format(
                            "Cannot find unbound4j native library for OS: %s, architecture: %s. See "
                                    + "https://github.com/OpenNMS/unbound4j/tree/master/README.md"
                                    ...
                                    + " org.opennms.unbound4j.NativeLibrary.DEBUG=1 to the system properties of the JVM.",
                            os(), architecture()));
        }
        try {
    ...
    private static String makeResourceName(String baseName) {
        return "org/opennms/unbound4j/native/" + String.format("%s-%s/", os(), architecture()) + baseName;
    }
    ...
    private static File createTemporaryDirectory() {
        ...
        String directoryName = "unbound4j_native_libraries-" + System.currentTimeMillis() + "-";
        ...
        throw new IllegalStateException(
                "Could not create a temporary directory (tried to make "
                        + directoryName
                        + "*) to extract unbound4j native libraries.");
    }
